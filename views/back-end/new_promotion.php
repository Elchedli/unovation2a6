...
if(isset($_POST['new_promo'])){
	...
	if(($picture_name = upload_picture($picture)) == null){
		...
		$add = $promotion->addPromotion($db, $promotion_tmp);
		if($add == true) {
			$success = "Votre promotion a été ajouté avec succès.";
		}else{
                    ...
                    <div class="col-lg-12">
						...
						<div class="card">
                            <div class="card-header">
                                <strong class="card-title">Nouvelle Promotion</strong>
                            ...
                            <div class="card-body card-block">
                                <form action="#" method="post" enctype="multipart/form-data" class="form-horizontal">
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="text" id="text-input" name="name" placeholder="Promotion Eté 2109" class="form-control" required><small class="form-text text-muted">Nom de la promotion</small></div>
                                    </div>
                                    <div class="row form-group">
                                        <div class="col col-md-3"><label for="pourcentage" class=" form-control-label">Pourcentage</label></div>
                                        <div class="col-12 col-md-9">
											<div class="input-group">
												<input type="text" id="pourcentage" name="pourcentage" placeholder="15" class="form-control" required><div class="input-group-addon">%</div>
											</div>
									...
									<div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9">
											<input class="form-control" type="date" value="2011-08-19" name="expiration" id="expiration">
										</div>
                                    </div>
									<div class="row form-group">
                                            ...
                                            <div class="form-check-inline">
                                                <div class="radio">
                                                    <label for="radio1" class="form-check-label ">
                                                        <input type="radio" name="is_active" value="true" class="form-check-input" checked>Active
                                                    </label>
                                                </div>
                                                <div class="radio">
                                                    <label for="radio2" class="form-check-label ">
                                                        <input type="radio" name="is_active" value="false" class="form-check-input">Non Active
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input type="file" id="picture" name="picture" class="form-control-file" required></div>
                                    </div>
									<div class="form-actions form-group">
										<button type="submit" name="new_promo" class="btn btn-success btn-sm">Ajouter</button>
